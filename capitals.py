...
def main():
    ...
    capitals = {'Alabama':'Montgomery', 'Alaska':'Juneau',
                ...
                'Rhode Island':'Province', 'South Carolina':'Columbia',
                'South Dakota':'Pierre', 'Tennessee':'Nashville',
                'Texas':'Austin', 'Utah':'Salt Lake City',
                'Vermont':'Montpelier', 'Virginia':'Richmond',
                'Washington':'Olympia', 'West Virginia':'Charleston',
                'Wisonsin':'Madison', 'Wyoming':'Cheyenne'}
    ...
    while next_question:
        ...
        # Get user solution
        user_solution = input('What is the capital of ' + current_state + '? (or enter 0 to quit): ')
